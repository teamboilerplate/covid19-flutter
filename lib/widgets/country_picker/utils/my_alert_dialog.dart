...
class MyAlertDialog<T> extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Adding the padding and the title if it is provied
    if (title != null) {
    ...
    // Creating a semantics to provide to the Semantics tools - Screen Readers, Search Engines and more
    else {
    ...
    // Adding the content provided it is not null
    if (content != null) {
    ...
    // Putting the Title and Content together in a Column
    ...
    // Setting the Semantics label, if and when provided
    if (label != null) {
      dialogChild =
          Semantics(namesRoute: true, label: label, child: dialogChild);
    }

    // Adding the content to the Dialog and returning it
    return Dialog(
